  ...
  return (
    <Container>
      ...
      <p>
         ...
         back to you. You have the option to object to such analyses or you can
      ...
      <p>
        ...
        75008 PARIS <br />
        01 72 74 10 44 <br />
        contact(at)oressearch.com <br />
        www.oressearch.com <br />
      </p>
      <p>
      ...
      <p>
        Revocation of your consent to the processing of data A wide range of data
        processing transactions are possible only subject to your express
        consent. You can also revoke at any time any consent you have already
      ...
      <p>
          ...
          optimised provision of the operator’s services. If other cookies
          (e.g. cookies for the analysis of your browsing patterns) should be
          stored, they are addressed separately in this Data Protection
          Declaration.
      </p>
      <p>
